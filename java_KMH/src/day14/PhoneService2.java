	...
	*/
	...
	void searchInfo() {
		...
		if(idx > -1) {
			...
			System.out.println("번호 : " + phoneBookList.get(idx).getPhoneNum());
			System.out.println();
		} else {
	...
	void  modifyInfo() {
		...
		if (idx > -1) {
			...
			if(selectMenu == 1) {
				...
				phoneBookList.get(idx).setName(changeName);
				...
				phoneBookList.get(idx).setName(changeNum);
