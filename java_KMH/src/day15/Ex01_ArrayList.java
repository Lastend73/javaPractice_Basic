...
//		ArrayList 회원목록
		...
		ArrayList<Member> memList = new ArrayList<Member>();  //기본 10개로 잡힘
		...
		mem01.setMpw("pw01");
		//회원정보를 회원목록에 저장
		memList.add(mem01); // 배열이면 memArr[0] = mem01;
		...
		System.out.println("size : " + memList.size()); //arrayList 떄는 length가 아닌 size 활용.
	}
